...
<form action="../_sys/adiciona-produto.php" method="post">
	<table class="table">
        ...
        <tr>
            <td><input class="form-control" type="text" name="nome_produto"></td>
        </tr>
        <tr>
            <td><label for="preco">preco</label></td>
        </tr>
        <tr>
            <td><input class="form-control" type="text" name="preco_produto"></td>
        </tr>
        <tr>
            <td><label for="quantidade">Quantidade</label></td>
        </tr>
        <tr>
            <td><input class="form-control" type="text" name="quantidade_produto"></td>
        </tr>
        <tr>
